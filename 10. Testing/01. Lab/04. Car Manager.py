...
class TestCar(TestCase):
    def setUp(self) -> None:
        self.car = Car(make="Test", model="TestModel", fuel_capacity=100, fuel_consumption=5.6)
    ...
    def test_set_fuel_consumption(self):
        self.car.fuel_consumption = 7.8
        self.assertEqual(7.8, self.car.fuel_consumption)
